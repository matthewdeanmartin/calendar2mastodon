...
<!-- TODO (generated from template — delete this block once done)
  ...
  - [ ] Add a PyPI badge: https://badge.fury.io/py/calendar2mastodon
  - [ ] Add a CI badge from your GitHub Actions build.yml
  - [ ] Fill in docs/overview/README.md with a real project overview
  - [ ] Add real subcommands to calendar2mastodon/cli.py and update scripts/basic_checks.sh
...
```bash
pipx install calendar2mastodon
```

Or with pip:

```bash
pip install calendar2mastodon
```
